...
<%
    Customer c = (Customer) request.getAttribute("obj");
...
<div class="am-cf admin-main">
    ...
    <div class="admin-content">
        ...
        <form id="fmMain" name="fmMain" class="am-form am-form-horizontal"
              action="${base}/customer/cust/upd.io" method="post">
                ...
                <div class="am-tab-panel am-fade am-in am-active" id="tab3">
                    <div class="am-g am-margin-top-sm">
                        ...
                        <div class="am-u-sm-4 am-u-end">
                            <input id="cid" name="cid" value="${c.cid}" type="text" class="am-input-sm" readonly>
                        </div>
                    </div>
                    <div class="am-g am-margin-top-sm">
                    ...
                    <div class="am-g am-margin-top-sm">
                        ...
                        <div class="am-u-sm-4 am-u-end">
                            <input id="birth" name="birth" value="${one:dateToStringShort(c.birth)}"
                    ...
                    <div class="am-g am-margin-top-sm">
                        ...
                        <div class="am-u-sm-7 am-u-end">
                            <input id="address" name="address" value="${c.address}" type="text" class="am-input-sm">
                    ...
                    <div class="am-g am-margin-top-sm">
                        ...
                        <div class="am-u-sm-4 am-u-end">
                            <input id="remark" name="remark" value="${c.remark}" type="text" class="am-input-sm">
                        </div>
                    </div>
                </div>
            </div>
