...
--
-- Host: 192.168.1.103    Database: mg-prod
-- ------------------------------------------------------
...
INSERT INTO `t_app_info` VALUES ('app_name','gallery'),('app_version','0.6.3'),('db_version','0.6.3'),('user_test','000000'),('update_date','20160920');
...
CREATE TABLE `t_cart` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 AVG_ROW_LENGTH=1 COMMENT='购物车';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_goods` (
  ...
  `state` char(2) NOT NULL COMMENT '0：已删除；1：有效；',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=52 DEFAULT CHARSET=utf8 COMMENT='商品表。 TODO -OPT 以后扩展：供应商，厂家，品牌等';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_item` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8 COMMENT='购物车-商品项表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_sku` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=85 DEFAULT CHARSET=utf8 COMMENT='商品SKU主表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_sku_more` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `sku_id` int(11) NOT NULL COMMENT 't_sku表的id',
  `size` varchar(50) DEFAULT NULL COMMENT '取值为t_sku_dict表的SIZE_STANDARD相关item',
  `count` int(11) unsigned NOT NULL COMMENT '数量',
  `remark` varchar(50) DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=493 DEFAULT CHARSET=utf8 COMMENT='商品SKU更多表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2016-09-20 22:36:04
