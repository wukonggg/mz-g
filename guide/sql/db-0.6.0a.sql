...
INSERT INTO `t_app_info` VALUES ('app_name','mz-gallery'),('app_version','0.6.0a'),('db_version','0.6.0a');
...
CREATE TABLE `t_cart` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AVG_ROW_LENGTH=1 COMMENT='购物车';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `t_customer` VALUES (1,'00000004','非会员顾客','2014-11-16','','00000004','','非会员顾客购买时使用',0,'1'),(2,'90001001','Alex-阿莱克斯',NULL,'19012341001','90001001','','',20,'1'),(3,'90001002','Black-布莱克',NULL,'19012341002','90001002','','',200,'1');
...
CREATE TABLE `t_sku_more` (
  ...
  `remark` varchar(50) DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='商品SKU更多表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `t_user` VALUES (1,'admin','8d969eef6ecad3c29a3a629280e686cf0c3f5d5a86aff3ca12020c923adc6c92',0,'1','2015-09-12 17:28:48','2015-09-12 17:28:48');
...
-- Dump completed on 2016-03-26 17:47:54
