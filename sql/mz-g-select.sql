...
select *
from v_sku_more t
where (t.cateCode = 'S-1' and t.count <= 8)
or ((t.cateCode = 'S-2' and t.count <= 8))
or ((t.cateCode = 'S-3' and t.count <= 8))
or ((t.cateCode = 'S-4' and t.count <= 8))
order by t.cateCode, t.count asc;