...
INSERT INTO `t_goods` (`id`, `cate_code`, `gname`, `words`, `img`, `ctime`, `utime`, `state`) VALUES
	(1, 'S-D', 'bbd', '', 'fdfffb75-2ade-4811-9b2e-c7abd5d39844.png', '2015-10-04 01:15:58', NULL, '1');
...
INSERT INTO `t_item` (`id`, `sku_id`, `sku_more_id`, `cate_code_snapshot`, `sprice_snapshot`, `dprice`, `dcount`, `payment`, `return_time`, `return_user_id`, `return_reason`, `return_desc`, `state`, `order_id`) VALUES
	(1, 1, 2, 'S-D', 200, 200, 1, 200, NULL, 0, NULL, NULL, '1', 1);
...
CREATE TABLE IF NOT EXISTS `t_sku` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='商品SKU主表';
...
INSERT INTO `t_sku` (`id`, `sid`, `model`, `type`, `ptime`, `pprice`, `sprice`, `img`, `ctime`, `utime`, `state`, `goods_id`) VALUES
	(1, 'D000000X1001', 'blue', 'LENGTH', '2015-10-04 00:00:00', 100, 200, 'D000000X1001.png', '2015-10-04 01:17:03', NULL, '1', 1),
	(2, 'D000000M1002', 'black', 'LENGTH', '2015-10-04 00:00:00', 100, 200, 'D000000M1002.png', '2015-10-04 01:19:30', '2015-10-04 23:10:56', '0', 1);
...
CREATE TABLE IF NOT EXISTS `t_sku_more` (
  ...
  `remark` varchar(50) DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8 COMMENT='商品SKU更多表';
